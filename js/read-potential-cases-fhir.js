...
(async () => {
  ...
  await fs.writeFile("peripheral-vascular-disease-charlson-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("peripheral-vascular-disease-charlson-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
